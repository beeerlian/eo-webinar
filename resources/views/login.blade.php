        ...
        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
          <div class="hero-text">
            ...
            <form action="/login" method="post" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
              ...
              <div class="col-lg-12 col-12">
                <button type="submit" class="form-control" id="submit-button" name="btn-input">Sign In</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-7 mx-auto col-md-10 col-12">
          <div class="about-info">
            ...
            <h2 class="mb-4" data-aos="fade-up">E-Learning merupakan suatu<strong> website pembelajaran online</strong>
            </h2>
            ...
            <p class="mb-0" data-aos="fade-up">Mempermudah siswa untuk bergabung 
              ...
              Berisi kelas-kelas dari pemateri terbaik, dan tema yang up-to-date dengan perkembangan zaman.
            </p>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-7 col-12">
          ...
          <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">Aplikasi yang sangat bagus, sehingga memudahkan antara guru dan siswa untuk berinteraksi melalui metode pembelajaran online.</h2>
